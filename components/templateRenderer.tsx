      ...
      <tr>
        ...
        <td width="90%" style="border-right:1px solid #000000;text-align:center;padding:20px 0 0;">
          ...
          <div style=";width:100%;display:grid;grid-template-columns:repeat(4,1fr);margin-top:20px;">
            <div style="background-color:${newsletter.elements[0].bgColor};width:100%;aspect-ratio:1/1;border-top:1px solid #000000;overflow:hidden;"><img src="https://prispevky.sferagrafika.eu/img/elements/${newsletter.elements[0].elementSet.elementPrefix}_motiv${newsletter.elements[0].elementNo}.png" alt="" style="width:100%;height:100%;object-fit:cover;" /></div>
            <div style="background-color:${newsletter.elements[1].bgColor};width:100%;aspect-ratio:1/1;border-top:1px solid #000000;border-left:1px solid #000000;overflow:hidden;"><img src="https://prispevky.sferagrafika.eu/img/elements/${newsletter.elements[1].elementSet.elementPrefix}_motiv${newsletter.elements[1].elementNo}.png" alt="" style="width:100%;height:100%;object-fit:cover;" /></div>
            <div style="background-color:${newsletter.elements[2].bgColor};width:100%;aspect-ratio:1/1;border-top:1px solid #000000;border-left:1px solid #000000;overflow:hidden;"><img src="https://prispevky.sferagrafika.eu/img/elements/${newsletter.elements[2].elementSet.elementPrefix}_motiv${newsletter.elements[2].elementNo}.png" alt="" style="width:100%;height:100%;object-fit:cover;" /></div>
            <div style="background-color:${newsletter.elements[3].bgColor};width:calc(100% - 1px);aspect-ratio:1/1;border-top:1px solid #000000;border-left:1px solid #000000;overflow:hidden;"><img src="https://prispevky.sferagrafika.eu/img/elements/${newsletter.elements[3].elementSet.elementPrefix}_motiv${newsletter.elements[3].elementNo}.png" alt="" style="width:100%;height:100%;object-fit:cover;" /></div>
          </div>
        </td>
        <td width="5%"></td>
      </tr>
